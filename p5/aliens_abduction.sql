...
# INSERT statement for aliens_abduction table

# SELECT statements for for aliens_abduction table

SELECT * FROM aliens_abduction WHERE first_name LIKE 'M%';

SELECT * FROM aliens_abduction WHERE 

# SQL Fiddle URL for aliens_abduction table
